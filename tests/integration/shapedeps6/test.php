...
firstParamFooSecondFoo_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2
firstParamFooSecondFoo_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamFooSecondFoo_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1
firstParamFooSecondFoo_echoAllPathKeys( getHTML(), $_GET['b'] ); // TODO HTML 1 & 2
firstParamFooSecondFoo_echoAllPathKeys( getHTML(), getHTML() ); // HTML 1 & 2
firstParamFooSecondFoo_echoAllPathKeys( getHTML(), getPath() ); // TODO HTML 1
firstParamFooSecondFoo_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2
firstParamFooSecondFoo_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamFooSecondFoo_echoAllPathKeys( getPath(), getPath() ); // TODO Safe
...
firstParamFooSecondBar_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2
firstParamFooSecondBar_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamFooSecondBar_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1
firstParamFooSecondBar_echoAllPathKeys( getHTML(), $_GET['b'] ); // TODO HTML 1 & 2
firstParamFooSecondBar_echoAllPathKeys( getHTML(), getHTML() ); // HTML 1 & 2
firstParamFooSecondBar_echoAllPathKeys( getHTML(), getPath() ); // TODO HTML 1
firstParamFooSecondBar_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2
firstParamFooSecondBar_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamFooSecondBar_echoAllPathKeys( getPath(), getPath() ); // TODO Safe
...
firstParamFooSecondUnknown_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2
firstParamFooSecondUnknown_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamFooSecondUnknown_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1
firstParamFooSecondUnknown_echoAllPathKeys( getHTML(), $_GET['b'] ); // TODO HTML 1 & 2
firstParamFooSecondUnknown_echoAllPathKeys( getHTML(), getHTML() ); // HTML 1 & 2
firstParamFooSecondUnknown_echoAllPathKeys( getHTML(), getPath() ); // TODO HTML 1
firstParamFooSecondUnknown_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2
firstParamFooSecondUnknown_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamFooSecondUnknown_echoAllPathKeys( getPath(), getPath() ); // TODO Safe
...
firstParamFooSecondKey_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2, PATH 2
firstParamFooSecondKey_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamFooSecondKey_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1, PATH 2
...
firstParamFooSecondKey_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2, PATH 2
firstParamFooSecondKey_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamFooSecondKey_echoAllPathKeys( getPath(), getPath() ); // TODO PATH 2
...
firstParamBarSecondBar_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2
firstParamBarSecondBar_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamBarSecondBar_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1
firstParamBarSecondBar_echoAllPathKeys( getHTML(), $_GET['b'] ); // TODO HTML 1 & 2
firstParamBarSecondBar_echoAllPathKeys( getHTML(), getHTML() ); // HTML 1 & 2
firstParamBarSecondBar_echoAllPathKeys( getHTML(), getPath() ); // TODO HTML 1
firstParamBarSecondBar_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2
firstParamBarSecondBar_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamBarSecondBar_echoAllPathKeys( getPath(), getPath() ); // TODO Safe
...
firstParamBarSecondUnknown_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2
firstParamBarSecondUnknown_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamBarSecondUnknown_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1
firstParamBarSecondUnknown_echoAllPathKeys( getHTML(), $_GET['b'] ); // TODO HTML 1 & 2
firstParamBarSecondUnknown_echoAllPathKeys( getHTML(), getHTML() ); // HTML 1 & 2
firstParamBarSecondUnknown_echoAllPathKeys( getHTML(), getPath() ); // TODO HTML 1
firstParamBarSecondUnknown_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2
firstParamBarSecondUnknown_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamBarSecondUnknown_echoAllPathKeys( getPath(), getPath() ); // TODO Safe
...
firstParamBarSecondKey_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2, PATH 2
firstParamBarSecondKey_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamBarSecondKey_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1, PATH 2
...
firstParamBarSecondKey_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2, PATH 2
firstParamBarSecondKey_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamBarSecondKey_echoAllPathKeys( getPath(), getPath() ); // TODO PATH 2
...
firstParamUnknownSecondUnknown_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2
firstParamUnknownSecondUnknown_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamUnknownSecondUnknown_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1
firstParamUnknownSecondUnknown_echoAllPathKeys( getHTML(), $_GET['b'] ); // TODO HTML 1 & 2
firstParamUnknownSecondUnknown_echoAllPathKeys( getHTML(), getHTML() ); // HTML 1 & 2
firstParamUnknownSecondUnknown_echoAllPathKeys( getHTML(), getPath() ); // TODO HTML 1
firstParamUnknownSecondUnknown_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2
firstParamUnknownSecondUnknown_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamUnknownSecondUnknown_echoAllPathKeys( getPath(), getPath() ); // TODO Safe
...
firstParamUnknownSecondKey_echoAllPathKeys( $_GET['a'], $_GET['b'] ); // TODO HTML 1 & 2, PATH 2
firstParamUnknownSecondKey_echoAllPathKeys( $_GET['a'], getHTML() ); // TODO HTML 1 & 2
firstParamUnknownSecondKey_echoAllPathKeys( $_GET['a'], getPath() ); // TODO HTML 1, PATH 2
...
firstParamUnknownSecondKey_echoAllPathKeys( getPath(), $_GET['b'] ); // TODO HTML 2, PATH 2
firstParamUnknownSecondKey_echoAllPathKeys( getPath(), getHTML() ); // TODO HTML 2
firstParamUnknownSecondKey_echoAllPathKeys( getPath(), getPath() ); // TODO PATH 2
