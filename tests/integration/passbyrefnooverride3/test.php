...
$var2 = $_GET['baz'];
indirect( $var2 );
echo $var2;// Unsafe, TODO caused by lines 17, 18, 13, 14 (in this order)
...
$var3 = $_GET['baz'];
usingList( $var3 );
echo $var3;// Unsafe, TODO caused by lines 27, 28, 23, 24 (in this order)
...
$var4 = $_GET['baz'];
ternary( $var4 );
echo $var4;// Unsafe, TODO caused by lines 37, 38, 33, 34 (in this order)
